  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '1rem' }}>
      <div className="glass-card" style={{ width: '100%', maxWidth: '800px', minHeight: '600px', maxHeight: '95vh', backgroundColor: 'var(--bg-color)', borderRadius: '20px', display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, padding: '2rem', display: 'flex', flexDirection: 'column', borderRight: '1px solid #e5e7eb', backgroundColor: 'white', overflowY: 'auto' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            {appliedCoupon ? (
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.75rem 1rem', backgroundColor: '#ecfdf5', borderRadius: '10px', border: '1px solid #a7f3d0' }}>
                <div>
              ...
              <>
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <input 
                    ...
                    style={{ flex: 1, padding: '0.75rem', borderRadius: '10px', border: '1px solid #e5e7eb', outline: 'none' }}
                  />
                  <button 
                    onClick={handleApplyCoupon}
                    style={{ padding: '0.75rem 1.5rem', borderRadius: '10px', backgroundColor: 'var(--accent-primary)', color: 'white', border: 'none', fontWeight: 600, cursor: 'pointer' }}
                  >
                    Apply
                  </button>
                </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <button 
              ...
              style={{ padding: '1.5rem 1rem', borderRadius: '12px', border: method === 'UPI' ? '2px solid var(--accent-primary)' : '1px solid #e5e7eb', backgroundColor: method === 'UPI' ? '#eef2ff' : 'white', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
        ...
        <div style={{ width: '350px', padding: '2rem', display: 'flex', flexDirection: 'column', backgroundColor: '#f9fafb', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {method === 'UPI' ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '0.8rem', color: '#9ca3af', maxWidth: '250px' }}>
